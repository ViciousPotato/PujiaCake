...
module.exports = function(app) {
  app.post('/admin/add_product', utils.auth, function(req, res) {
    var product;
    product = new Product({
  ...
  app.get('/admin/product', utils.auth, function(req, res) {
    return res.render('admin_product.jade');
  });
  app.get('/admin/list_product', utils.auth, function(req, res) {
    return Product.find(function(err, products) {
      return res.json(products);
    });
  });
  app.get('/admin/delete_product/:proudctid', utils.auth, function(req, res) {
  ...
  app.post('/admin/update_product', utils.auth, function(req, res) {
    var key, setval, val;
    setval = {};
    key = req.param("name");
    val = req.param("value");
  ...
  app.get('/admin/product/:id/detail', utils.auth, function(req, res) {
  ...
  return app.post('/admin/product/:id/detail', utils.auth, function(req, res) {
    return Product.update({
      _id: req.params.id
    }, {
      $set: {
